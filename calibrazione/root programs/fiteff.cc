...
void eff() {
  ...
  TF1 *f1 = new TF1("f1", fit_hurtado, 40, 1500, 7);
 ...
 TF1 *f2 = new TF1("f2", fit_hurtado2, 40, 1500, 8);
  ...
  TF1 *f3 = new TF1("f3", fit_hurtado2, 40, 1500, 8);
...
TF1 *zero = new TF1("zero", fitzero2, 36, 1500, 2);
    zero->SetLineStyle(9);
    zero->SetLineColor(7);
