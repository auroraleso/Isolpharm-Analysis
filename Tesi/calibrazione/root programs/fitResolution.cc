...
void lin2() {
  ...
  TGraphErrors *g = new TGraphErrors("dataResolutionHPGe.txt");
...
TMultiGraph* mg = new TMultiGraph();
    mg->Add(g);
    mg->Draw("ap");
    mg->SetTitle("Risoluzione detector HPGe");
  ...
  gr->SetTitle("Residui Risoluzione HPGe");
  ...
  TF1 *zero = new TF1("zero", fitzero2, 0, 10000, 2);
   ...
   TMultiGraph* mg1 = new TMultiGraph();
    mg1->Add(gr);
    mg1->Draw("AP");
    mg1->SetTitle("Residui risoluzione detector HPGe");
