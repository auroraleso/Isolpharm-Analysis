...
//   TGraphErrors *g1 = new TGraphErrors("342.txt");
...
//   TF1 *f2 = new TF1("f2", fitfretta, 3000, 90000, 2);
//   f2->SetLineStyle(1);
//     f2->SetLineColor(2);
//     f2->SetLineWidth(1);
//   // setta i valori iniziali dei parametri
...
//     mg->Add(g1);
//     mg->Draw("ap");
//     mg->SetTitle("Pd-enriched, 2nd data sample,  Area 245 peak versus time for HPGe");
//     mg->GetYaxis()->SetTitle("Area ");
...
//   TF1 *zero = new TF1("zero", fitzero, 3000, 90000, 2);
//     zero->SetLineStyle(9);
//     zero->SetLineColor(7);
//    TMultiGraph* mg1 = new TMultiGraph();
//     mg1->Add(gr);
//     mg1->Draw("AP");
//     mg1->SetTitle("Pd-enriched, 2nd data sample,  Residuals from area 245 peak versus time for HPGe");
